...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__signin_signin_component__ = __webpack_require__("../../../../../src/app/auth/signin/signin.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__signup_signup_component__ = __webpack_require__("../../../../../src/app/auth/signup/signup.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(route, router, authService, tileService) {
        this.route = route;
        this.router = router;
    ...
    SigninComponent.prototype.onSignin = function (form) {
        ...
        this.authService.signinUser(email, password)
            ...
            _this.authService.setToken(response.headers.get('x-auth'));
            _this.authService.setUser(response.body);
            _this.tileService.fetchTilesListFromDatabase();
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(route, router, authService, tileService) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.tileService = tileService;
